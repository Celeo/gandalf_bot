...
QUOTES = [
    ...
    "Your treachery has already cost many lives. Thousands more are now at risk. But you could save them CyberStryke96. You were deep in the enemy's counsel.",
    ...
    "Just tea, thank you.",
    "Tapir9662! The ring is still in your pocket.",
    ...
    "End? No the journey doesn't end here. Death is but another path, one that we all must take. The gray rain curtain of this world rolls back. And all turns to silver glass. Then you see it Raedwulf1",
    "Into the Mines!",
    "Fool of a Took!",
